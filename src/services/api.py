...
def delete_account_api(user_id):
    ...
    database.delete_row("DELETE FROM users u WHERE u.user_id=%s", (
        user_id,))  # TODO: Add ON_DELETE Cascade, with user and user_profile table. Don't need to repeat delete twice.
